...
#
# On Windows the SODIUM_ROOT environment variable is used as a default hint which
...
if(UNIX OR CMAKE_SYSTEM_NAME STREQUAL "Generic")
  ...
  # Windows
elseif(WIN32)
  set(SODIUM_ROOT "$ENV{SODIUM_ROOT}" CACHE FILEPATH "sodium install directory")
  mark_as_advanced(SODIUM_ROOT)
